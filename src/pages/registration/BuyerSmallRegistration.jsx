...
function BuyerSmallRegistration() {
    ...
    const handleRegisterSmallBuyer = async (e) => {
        e.preventDefault();
        setError("");
        setSuccess("");
        ...
        try {
            // Small buyer registration - minimal fields needed
            const userData = {
                nik: "", // Optional for small buyers
                buyerrole: "normal" // This is a normal/small scale buyer
            };
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 max-w-6xl mx-auto">
          ...
          <div className="w-full md:w-1/2 max-w-md">
            <form onSubmit={handleRegisterSmallBuyer} className="bg-gray-100 p-8 rounded-lg shadow-md border border-gray-200">
...
export default BuyerSmallRegistration;
